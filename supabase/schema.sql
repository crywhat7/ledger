-- ============================================
-- LEDGER PWA - Custom Auth & Finance Schema
-- Run in Supabase SQL Editor (RLS disabled by design)
-- ============================================
...
-- ============================================
-- PROFILES (Custom Auth - NO Supabase Auth)
-- ============================================
...
-- ============================================
-- INCOME SCHEDULES (Dynamic budgeting)
-- ============================================
...
-- ============================================
-- TRANSACTIONS (Libro Diario - Daily Ledger)
-- ============================================
CREATE TABLE IF NOT EXISTS transactions (
  ...
  amount DECIMAL(18, 2) NOT NULL,
  concept TEXT,
  -- Primary account (from/to)
  account_id UUID REFERENCES accounts(id) ON DELETE SET NULL,
  -- For transfers: destination account
  to_account_id UUID REFERENCES accounts(id) ON DELETE SET NULL,
  -- For CC: link to credit card account
...
-- ============================================
-- BUDGETS (Weekly/Monthly allocation)
-- ============================================
...
-- ============================================
-- WEEKLY ROLLOVER (Surplus tracking)
-- ============================================
...
-- ============================================
-- MONTHLY DECISIONS (Save / Splurge / Reset)
-- ============================================
...
-- ============================================
-- INCOME REGISTRATION LOG (for 1PM payday reminder)
-- ============================================
...
-- ============================================
-- RLS: DISABLED — Manual isolation via user_id in app
-- ============================================
